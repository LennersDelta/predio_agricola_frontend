...
function VerAnticipoRendirCuentaPageInner() {
  ...
  useEffect(() => {
    ...
    const cargar = async () => {
      try {
        ...
        console.error(error);
        toast.error('No se pudo cargar los anticipo rendir cuentas');
      } finally {
        setCargando(false);
      }
    };cargar();
  ...
  if (cargando) {
    return (
      ...
      >
        Cargando Anticipo Rendir Cuentas...
      </div>
    );
  }
            ...
            <Section>
                ...
                >
                    ...
                    <Field label="N° Cuenta">
                        <FInput readOnly value={form.numero_cuenta} />
                    </Field>

                    <Field label="Nombre Cuenta">
                        <FInput readOnly value={form.nombre_cuenta} />
                    </Field>
...
export default function VerAnticipoRendirCuentaPage() {
  return (
    <Suspense>
      <VerAnticipoRendirCuentaPageInner />
    </Suspense>
  );
}