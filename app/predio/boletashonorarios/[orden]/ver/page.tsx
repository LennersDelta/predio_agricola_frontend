...
function VerBoletaHonorarioPageInner() {
    ...
    <div style={{ fontFamily: '"Barlow",sans-serif' }}>
      ...
      <form>
            ...
            >
                ...
                <FInput
                    readOnly
                    value={Number(form.total || 0).toLocaleString('es-CL')}
                />
                </Field>
...
export default function VerBoletaHonorarioPage() {
  return (
    <Suspense>
      <VerBoletaHonorarioPageInner />
    </Suspense>
  );
}