...
export default function CrearCompra3UTMPage() {
  ...
  //  Submit 
    ...
    if (!form.proveedor)
    errsFront.proveedor = 'Debe ingresar el proveedor.';

    if (!form.factura)
    errsFront.factura = 'Debe ingresar la factura.';
    ...
    if (!form.materia)
    errsFront.materia = 'Debe ingresar la materia.';

   if (!form.estado_id)
    errsFront.estado_id = 'Debe seleccionar el estado.';

    if (!form.doe_envio_ab5)
    errsFront.doe_envio_ab5 = 'Debe ingresar DOE envío a pago.';
    ...
    try{
      ...
      await api.post('/api/compra3utm/insert', fd, {
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between',
          ...
          <div>
            ...
            <p style={{ fontSize: '.72rem', color: '#3d5c47', fontFamily: 'monospace' }}>
               Complete la información de la compra 3 UTM
            </p>
          </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                >
                  ...
                  {loading ? 'Guardando...' : 'Guardar compra 3 UTM'}
                </button>
              </div>
            </div>
          </div>
