...
function EditarAguaPageInner() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      await api.put(
        `/api/factura/agua/${uuid}`,
        payload
      );

      toast.success('Factura de agua actualizada correctamente');
      ...
      const mensaje =
        ...
        'No se pudo actualizar la factura de agua';
...
export default function EditarAguaPage() {
  return (
    <Suspense>
      <EditarAguaPageInner />
    </Suspense>
