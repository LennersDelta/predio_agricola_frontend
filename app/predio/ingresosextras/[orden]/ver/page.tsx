...
function VerIngresosExtrasPageInner() {
    ...
    const cargar = async () => {
      try {
        ...
        setForm({
            ...
            estado_pago: data.data.estado_pago ?? '',
        ...
        console.error(error);
        toast.error('No se pudo cargar la ingresos extras');
      } finally {
        setCargando(false);
      }
    };cargar();
    ...
    <div style={{ fontFamily: '"Barlow",sans-serif' }}>
      ...
      <form>
            ...
            <Section>
                ...
                >
                    <Field label="Predio">
                        <FSelect disabled value={form.predio_id}>
                            <option value="">
                                {loadingPredios
                                    ? 'Cargando...'
                                    : errorPredios
                    ...
                    <Field label="Valor Total ($)">
                        <FInput
                            readOnly
                            value={Number(form.valor_total || 0).toLocaleString('es-CL')}
                        />
                    </Field>
                    ...
                    <Field label="Estado Pago">
                        <FInput
                            readOnly
                            value={obtenerEstadoPago(form.estado_pago)}
                        />
                    </Field>
                </div>
            </Section>
...
export default function VerIngresosExtrasPage() {
  return (
    <Suspense>
      <VerIngresosExtrasPageInner />
    </Suspense>
  );
}