// app/predio/rendicionmensual/crear/page.tsx
'use client';
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    await api.post('/api/rendicionmensual/insert', fd, {
      headers: {
        'Content-Type': 'multipart/form-data',
      },
    });

    toast.success('Rendición mensual guardada correctamente.');
    setTimeout(() => {
    ...
    if (err.response?.status === 422) {
        ...
        'Ya existe una rendición mensual para el predio y mes seleccionados.'
        );
    ...
    toast.error(
        err.response?.data?.message ?? 'Error al guardar la rendición mensual.',
        {
        duration: 5000,
        }
    );
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between',
          ...
          <div>
            ...
            <p style={{ fontSize: '.72rem', color: '#3d5c47', fontFamily: 'monospace' }}>
               Complete la información de la rendición mensual
            </p>
          </div>
          <Link href="/predio/rendicionmensual"
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                >
                  ...
                  {loading ? 'Guardando...' : 'Guardar rendicion mensual'}
                </button>
              </div>
            </div>
            </div>
